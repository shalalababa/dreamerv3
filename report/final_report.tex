...
exploration methods by the distribution they collect, rather than by downstream
return alone. Second, the choice of adaptation protocol is itself a finding, not a
...
contains the implementation and report figures used here; raw run outputs are
omitted from the repository. Reported numbers are computed by the probing pipeline
