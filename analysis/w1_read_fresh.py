"""DERIVED READER — fresh cohort seeds 59-66
(PREREG_p2_wave2_freshcohort_20260821, review B2). A literal copy of the
...
Changes vs w1_read.py:
  1. FILE_RES[tm2] seed group: 5[1-8] -> (?:59|6[0-6])
  2. DUP_RES[tm2] seed group:  5[1-8] -> (?:59|6[0-6])
"""
...
FILE_RES = dict(
    ...
    tm2=re.compile(r'^w1tm2_(cup|finger)_(e1|e4)_seed(?:(59|6[0-6]))_late\.npz$'))
DUP_RES = dict(
    dv3=re.compile(r'^w1dup_(cup|finger)_(e1|e4)_seed(3[1-8])_late\.npz$'),
    tm2=re.compile(r'^w1tm2dup_(cup|finger)_(e1|e4)_seed(?:(59|6[0-6]))_late\.npz$'))
