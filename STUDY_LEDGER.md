...
- **Stage-0 second-k robustness REGISTERED 07-30/31** (the Stage-0
  ...
  `local_results/stage0_secondk_20260801_212204/`; **json + code-sha
  provenance still on the instance — pull before teardown**;
  disclosure: the recommended twice-run probe was not executed —
  partially covered by same-session smoke pass + read).
