...
for N in "$@"; do
  ...
  rs "${DV3_RSYNC_OPTS[@]}" \
    ...
    --include=/hspilot/ \
  --include=/hspilot/hspilot_p05_seed0 \
  --include='/hspilot/hspilot_p05_seed0/***' \
  --include=/hspilot/hspilot_p05_seed1 \
  --include='/hspilot/hspilot_p05_seed1/***' \
  --include=/hspilot/hspilot_p095_seed0 \
  --include='/hspilot/hspilot_p095_seed0/***' \
  --include=/hspilot/hspilot_p095_seed1 \
  --include='/hspilot/hspilot_p095_seed1/***' \
    --include='/_cloud_logs/' \
    --include=/_cloud_logs/hspilot/hspilot_p05_seed0.out \
  --include=/_cloud_logs/hspilot/hspilot_p05_seed1.out \
  --include=/_cloud_logs/hspilot/hspilot_p095_seed0.out \
  --include=/_cloud_logs/hspilot/hspilot_p095_seed1.out \
...
echo "pulled. verify with: dv3ops check --wave hspilot"
