...
for N in "$@"; do
  ...
  rs "${DV3_RSYNC_OPTS[@]}" \
    ...
    --include=/se_donly_s10 \
  --include='/se_donly_s10/***' \
  --include=/se_donly_s11 \
  --include='/se_donly_s11/***' \
  --include=/se_donly_s12 \
  --include='/se_donly_s12/***' \
  --include=/se_donly_s13 \
  --include='/se_donly_s13/***' \
  --include=/se_gate_s20 \
  --include='/se_gate_s20/***' \
  --include=/se_gate_s21 \
  ...
  --include=/se_gate_s23 \
  --include='/se_gate_s23/***' \
  --include=/se_ungate_s24 \
  --include='/se_ungate_s24/***' \
  --include=/se_ungate_s25 \
  --include='/se_ungate_s25/***' \
  --include=/se_ungate_s26 \
  --include='/se_ungate_s26/***' \
  --include=/se_ungate_s27 \
  --include='/se_ungate_s27/***' \
    --include='/_cloud_logs/' \
    --include=/_cloud_logs/se_donly_s10.out \
  --include=/_cloud_logs/se_donly_s11.out \
  --include=/_cloud_logs/se_donly_s12.out \
  --include=/_cloud_logs/se_donly_s13.out \
  --include=/_cloud_logs/se_gate_s20.out \
  --include=/_cloud_logs/se_gate_s21.out \
  --include=/_cloud_logs/se_gate_s22.out \
  --include=/_cloud_logs/se_gate_s23.out \
  --include=/_cloud_logs/se_ungate_s24.out \
  --include=/_cloud_logs/se_ungate_s25.out \
  --include=/_cloud_logs/se_ungate_s26.out \
  --include=/_cloud_logs/se_ungate_s27.out \
...
echo "pulled. verify with: dv3ops check --wave se_arms"
