...
for N in "$@"; do
  ...
  --include='/se_noboot_s40/***' \
  --include=/se_noboot_s41 \
  --include='/se_noboot_s41/***' \
  --include=/se_noboot_s42 \
  --include='/se_noboot_s42/***' \
  --include=/se_noboot_s43 \
  --include='/se_noboot_s43/***' \
    --include='/_cloud_logs/' \
    --include=/_cloud_logs/se_noboot_s40.out \
  --include=/_cloud_logs/se_noboot_s41.out \
  --include=/_cloud_logs/se_noboot_s42.out \
  --include=/_cloud_logs/se_noboot_s43.out \
...
echo "pulled. verify with: dv3ops check --wave se_noboot"
