...
REMOTE="$REMOTE_ROOT/_waves/b5_tm2"
...
echo "-- stage qmask lane 0: 2 task(s) --"
dv3_ssh_dv3 "$N" "DV3_ABORT_ON_FAIL=0 dv3_queue_or_add \"$REMOTE/lane_qmask_0.cmds\" 0"
echo "-- stage qmask lane 1: 2 task(s) --"
dv3_ssh_dv3 "$N" "DV3_ABORT_ON_FAIL=0 dv3_queue_or_add \"$REMOTE/lane_qmask_1.cmds\" 1"
