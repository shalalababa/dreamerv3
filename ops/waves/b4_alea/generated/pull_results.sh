...
for N in "$@"; do
  ...
  rs "${DV3_RSYNC_OPTS[@]}" \
    ...
    --include=/se_alea_s120 \
  --include='/se_alea_s120/***' \
  --include=/se_alea_s121 \
  --include='/se_alea_s121/***' \
  --include=/se_alea_s122 \
  --include='/se_alea_s122/***' \
  --include=/se_alea_s123 \
  --include='/se_alea_s123/***' \
    --include='/_cloud_logs/' \
    --include=/_cloud_logs/se_alea_s120.out \
  --include=/_cloud_logs/se_alea_s121.out \
  --include=/_cloud_logs/se_alea_s122.out \
  --include=/_cloud_logs/se_alea_s123.out \
...
echo "pulled. verify with: dv3ops check --wave b4_alea"
