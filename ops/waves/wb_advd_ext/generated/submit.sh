...
REMOTE="$REMOTE_ROOT/_waves/wb_advd_ext"
...
echo "-- stage adapt_ext lane 0: 16 task(s) --"
dv3_ssh_dv3 "$N" "DV3_ABORT_ON_FAIL=0 dv3_queue_or_add \"$REMOTE/lane_adapt_ext_0.cmds\" 0"
