...
for N in "$@"; do
  ...
  rs "${DV3_RSYNC_OPTS[@]}" \
    ...
    --include=/se_advd_flat_s48 \
  --include='/se_advd_flat_s48/***' \
  --include=/se_advd_flat_s49 \
  --include='/se_advd_flat_s49/***' \
  --include=/se_advd_flat_s50 \
  --include='/se_advd_flat_s50/***' \
  --include=/se_advd_flat_s51 \
  --include='/se_advd_flat_s51/***' \
  --include=/se_advd_het_s44 \
  --include='/se_advd_het_s44/***' \
  --include=/se_advd_het_s45 \
  --include='/se_advd_het_s45/***' \
  --include=/se_advd_het_s46 \
  --include='/se_advd_het_s46/***' \
  --include=/se_advd_het_s47 \
  --include='/se_advd_het_s47/***' \
  --include=/se_advd_s10 \
  --include='/se_advd_s10/***' \
  --include=/se_advd_s11 \
  ...
  --include='/se_advd_s17/***' \
    --include='/_cloud_logs/' \
    --include=/_cloud_logs/se_advd_flat_s48.out \
  --include=/_cloud_logs/se_advd_flat_s49.out \
  --include=/_cloud_logs/se_advd_flat_s50.out \
  --include=/_cloud_logs/se_advd_flat_s51.out \
  --include=/_cloud_logs/se_advd_het_s44.out \
  --include=/_cloud_logs/se_advd_het_s45.out \
  --include=/_cloud_logs/se_advd_het_s46.out \
  --include=/_cloud_logs/se_advd_het_s47.out \
  --include=/_cloud_logs/se_advd_s10.out \
  --include=/_cloud_logs/se_advd_s11.out \
  --include=/_cloud_logs/se_advd_s12.out \
  --include=/_cloud_logs/se_advd_s13.out \
  --include=/_cloud_logs/se_advd_s14.out \
  --include=/_cloud_logs/se_advd_s15.out \
  --include=/_cloud_logs/se_advd_s16.out \
  --include=/_cloud_logs/se_advd_s17.out \
...
echo "pulled. verify with: dv3ops check --wave wb_advd_ext"
