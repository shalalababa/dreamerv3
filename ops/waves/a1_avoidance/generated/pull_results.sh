...
for N in "$@"; do
  ...
  rs "${DV3_RSYNC_OPTS[@]}" \
    ...
    --include=/se_avoid_flat_s48 \
  --include='/se_avoid_flat_s48/***' \
  --include=/se_avoid_flat_s49 \
  --include='/se_avoid_flat_s49/***' \
  --include=/se_avoid_flat_s50 \
  --include='/se_avoid_flat_s50/***' \
  --include=/se_avoid_flat_s51 \
  --include='/se_avoid_flat_s51/***' \
  --include=/se_avoid_het_s44 \
  --include='/se_avoid_het_s44/***' \
  --include=/se_avoid_het_s45 \
  --include='/se_avoid_het_s45/***' \
  --include=/se_avoid_het_s46 \
  --include='/se_avoid_het_s46/***' \
  --include=/se_avoid_het_s47 \
  --include='/se_avoid_het_s47/***' \
    --include='/_cloud_logs/' \
    --include=/_cloud_logs/se_avoid_flat_s48.out \
  --include=/_cloud_logs/se_avoid_flat_s49.out \
  --include=/_cloud_logs/se_avoid_flat_s50.out \
  --include=/_cloud_logs/se_avoid_flat_s51.out \
  --include=/_cloud_logs/se_avoid_het_s44.out \
  --include=/_cloud_logs/se_avoid_het_s45.out \
  --include=/_cloud_logs/se_avoid_het_s46.out \
  --include=/_cloud_logs/se_avoid_het_s47.out \
...
echo "pulled. verify with: dv3ops check --wave a1_avoidance"
