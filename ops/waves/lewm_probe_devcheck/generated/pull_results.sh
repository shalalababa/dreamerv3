...
for N in "$@"; do
  ...
  rs "${DV3_RSYNC_OPTS[@]}" \
    ...
    --include=/lewm_probe_devcheck/ \
  --include=/lewm_probe_devcheck/fpx_s0_seed6.json \
  --include='/lewm_probe_devcheck/fpx_s0_seed6.json/***' \
  --include=/lewm_probe_devcheck/fpx_s1_seed1.json \
  --include='/lewm_probe_devcheck/fpx_s1_seed1.json/***' \
  --include=/lewm_probe_devcheck/fpx_s1_seed3.json \
  --include='/lewm_probe_devcheck/fpx_s1_seed3.json/***' \
    --include='/_cloud_logs/' \
    --include=/_cloud_logs/lewm_probe_devcheck/fpx_s0_seed6.json.out \
  --include=/_cloud_logs/lewm_probe_devcheck/fpx_s1_seed1.json.out \
  --include=/_cloud_logs/lewm_probe_devcheck/fpx_s1_seed3.json.out \
