...
for N in "$@"; do
  ...
  --include='/se_apt_s75/***' \
    --include='/_cloud_logs/' \
    --include=/_cloud_logs/se_apt_s68.out \
  --include=/_cloud_logs/se_apt_s69.out \
  --include=/_cloud_logs/se_apt_s70.out \
  --include=/_cloud_logs/se_apt_s71.out \
  --include=/_cloud_logs/se_apt_s72.out \
  --include=/_cloud_logs/se_apt_s73.out \
  --include=/_cloud_logs/se_apt_s74.out \
  --include=/_cloud_logs/se_apt_s75.out \
...
echo "pulled. verify with: dv3ops check --wave b2_apt"
