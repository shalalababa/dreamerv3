...
for N in "$@"; do
  ...
  rs "${DV3_RSYNC_OPTS[@]}" \
    ...
    --include=/se_cheetah_seed10/ \
  --include=/se_cheetah_seed10/se_planner \
  --include='/se_cheetah_seed10/se_planner/***' \
  --include=/se_cheetah_seed11/ \
  --include=/se_cheetah_seed11/se_planner \
  --include='/se_cheetah_seed11/se_planner/***' \
  --include=/se_cheetah_seed12/ \
  --include=/se_cheetah_seed12/se_planner \
  --include='/se_cheetah_seed12/se_planner/***' \
  --include=/se_cheetah_seed13/ \
  --include=/se_cheetah_seed13/se_planner \
  --include='/se_cheetah_seed13/se_planner/***' \
  --include=/se_cheetah_seed14/ \
  --include=/se_cheetah_seed14/se_planner \
  --include='/se_cheetah_seed14/se_planner/***' \
  --include=/se_cheetah_seed15/ \
  --include=/se_cheetah_seed15/se_planner \
  --include='/se_cheetah_seed15/se_planner/***' \
  --include=/se_cheetah_seed16/ \
  --include=/se_cheetah_seed16/se_planner \
  --include='/se_cheetah_seed16/se_planner/***' \
  --include=/se_cheetah_seed17/ \
  --include=/se_cheetah_seed17/se_planner \
  --include='/se_cheetah_seed17/se_planner/***' \
    --include='/_cloud_logs/' \
    --include=/_cloud_logs/se_cheetah_seed10/se_planner.out \
  --include=/_cloud_logs/se_cheetah_seed11/se_planner.out \
  --include=/_cloud_logs/se_cheetah_seed12/se_planner.out \
  --include=/_cloud_logs/se_cheetah_seed13/se_planner.out \
  --include=/_cloud_logs/se_cheetah_seed14/se_planner.out \
  --include=/_cloud_logs/se_cheetah_seed15/se_planner.out \
  --include=/_cloud_logs/se_cheetah_seed16/se_planner.out \
  --include=/_cloud_logs/se_cheetah_seed17/se_planner.out \
...
echo "pulled. verify with: dv3ops check --wave b3_planner"
