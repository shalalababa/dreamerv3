...
REMOTE="$REMOTE_ROOT/_waves/b1_dose"
...
echo "-- stage train lane 4: 2 task(s) --"
dv3_ssh_dv3 "$N" "DV3_ABORT_ON_FAIL=0 dv3_queue_or_add \"$REMOTE/lane_train_4.cmds\" 4"
echo "-- stage train lane 5: 2 task(s) --"
dv3_ssh_dv3 "$N" "DV3_ABORT_ON_FAIL=0 dv3_queue_or_add \"$REMOTE/lane_train_5.cmds\" 5"
echo "-- stage train lane 6: 2 task(s) --"
dv3_ssh_dv3 "$N" "DV3_ABORT_ON_FAIL=0 dv3_queue_or_add \"$REMOTE/lane_train_6.cmds\" 6"
echo "-- stage train lane 7: 2 task(s) --"
dv3_ssh_dv3 "$N" "DV3_ABORT_ON_FAIL=0 dv3_queue_or_add \"$REMOTE/lane_train_7.cmds\" 7"
