...
for N in "$@"; do
  ...
  rs "${DV3_RSYNC_OPTS[@]}" \
    ...
    --include=/se_dose10_s52 \
  --include='/se_dose10_s52/***' \
  --include=/se_dose10_s53 \
  --include='/se_dose10_s53/***' \
  --include=/se_dose10_s54 \
  --include='/se_dose10_s54/***' \
  --include=/se_dose10_s55 \
  --include='/se_dose10_s55/***' \
  --include=/se_dose25_s56 \
  --include='/se_dose25_s56/***' \
  --include=/se_dose25_s57 \
  --include='/se_dose25_s57/***' \
  --include=/se_dose25_s58 \
  --include='/se_dose25_s58/***' \
  --include=/se_dose25_s59 \
  --include='/se_dose25_s59/***' \
  --include=/se_dose50_s60 \
  --include='/se_dose50_s60/***' \
  --include=/se_dose50_s61 \
  --include='/se_dose50_s61/***' \
  --include=/se_dose50_s62 \
  --include='/se_dose50_s62/***' \
  --include=/se_dose50_s63 \
  --include='/se_dose50_s63/***' \
  --include=/se_dose75_s64 \
  --include='/se_dose75_s64/***' \
  --include=/se_dose75_s65 \
  --include='/se_dose75_s65/***' \
  --include=/se_dose75_s66 \
  --include='/se_dose75_s66/***' \
  --include=/se_dose75_s67 \
  --include='/se_dose75_s67/***' \
    --include='/_cloud_logs/' \
    --include=/_cloud_logs/se_dose10_s52.out \
  --include=/_cloud_logs/se_dose10_s53.out \
  --include=/_cloud_logs/se_dose10_s54.out \
  --include=/_cloud_logs/se_dose10_s55.out \
  --include=/_cloud_logs/se_dose25_s56.out \
  --include=/_cloud_logs/se_dose25_s57.out \
  --include=/_cloud_logs/se_dose25_s58.out \
  --include=/_cloud_logs/se_dose25_s59.out \
  --include=/_cloud_logs/se_dose50_s60.out \
  --include=/_cloud_logs/se_dose50_s61.out \
  --include=/_cloud_logs/se_dose50_s62.out \
  --include=/_cloud_logs/se_dose50_s63.out \
  --include=/_cloud_logs/se_dose75_s64.out \
  --include=/_cloud_logs/se_dose75_s65.out \
  --include=/_cloud_logs/se_dose75_s66.out \
  --include=/_cloud_logs/se_dose75_s67.out \
...
echo "pulled. verify with: dv3ops check --wave b1_dose"
