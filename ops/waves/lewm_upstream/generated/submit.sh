...
REMOTE="$REMOTE_ROOT/_waves/lewm_upstream"
...
echo "-- stage distill lane 0: 4 task(s) --"
dv3_ssh_dv3 "$N" "DV3_ABORT_ON_FAIL=0 dv3_queue_or_add \"$REMOTE/lane_distill_0.cmds\" 0"
echo "-- stage distill lane 1: 4 task(s) --"
dv3_ssh_dv3 "$N" "DV3_ABORT_ON_FAIL=0 dv3_queue_or_add \"$REMOTE/lane_distill_1.cmds\" 1"
echo "-- stage distill lane 2: 4 task(s) --"
dv3_ssh_dv3 "$N" "DV3_ABORT_ON_FAIL=0 dv3_queue_or_add \"$REMOTE/lane_distill_2.cmds\" 2"
echo "-- stage distill lane 3: 4 task(s) --"
dv3_ssh_dv3 "$N" "DV3_ABORT_ON_FAIL=0 dv3_queue_or_add \"$REMOTE/lane_distill_3.cmds\" 3"
